...
const en = {
  ...
  explorer: {
    ...
    all: "All",
    allAreas: "All areas",
    pickRegion: "Pick an area",
    region: "Area",
    regionAll: "All areas",
    regionEmpty: "No areas in this city yet.",
    filters: "Filters",
...
const ar: typeof en = {
  ...
  explorer: {
    ...
    regionEmpty: "لا توجد مناطق في هذه المدينة بعد.",
    filters: "التصفية",
    clearFilters: "مسح التصفية",
    filterPrice: "السعر",
    filterFeatured: "مميز",
    filterFeaturedOn: "المميزة فقط",
    filterAmenities: "المرافق",
    filterTags: "الوسوم",
